...
//Created a function that removes a product from the cart then returns the new cart, if an item is not in the cart then it will simply return the cart as it is.
